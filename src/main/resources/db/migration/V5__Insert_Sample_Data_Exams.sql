INSERT INTO exam (id, customer, created, updated, deleted, duration, start_date, end_date)
    VALUES (1, 'foundationX', NOW(), NOW(), FALSE, 30, NOW(), NOW());
INSERT INTO exam (id, customer, created, updated, deleted, duration, start_date, end_date)
    VALUES (2, 'foundationY', NOW(), NOW(), FALSE, 30, NOW(), NOW());
